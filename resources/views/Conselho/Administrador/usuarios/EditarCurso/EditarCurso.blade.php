...
<div class="conteiner-fluid" style="margin: 10px">
    <div class="row justify-content-center">
        <h1 style="font-weight: strong; font-family: 'Tomorrow', sans-serif">
            Editar Curso
        </h1>
    </div>
    <div>
    ...
    <form>
        <div class="form-group row">
            <label style="font-weight: strong; font-family: 'Tomorrow', sans-serif" for="nome" class="col-2 col-form-label"
        ...
        <div class="form-group row">
            <label style="font-weight: strong; font-family: 'Tomorrow', sans-serif" for="modalidade" class="col-2 col-form-label"
