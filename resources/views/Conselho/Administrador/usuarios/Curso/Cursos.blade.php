...
<div class="table-responsive">
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td><a href="{{url('/editarcurso')}}"><img class="imagem-tabela" src="/conselho/_imagens/Editar.svg" alt=""></a></td>
    ...
    <a class="btn btn-secondary btn-md" style="margin: 5px" href="{{url('/adicionarcurso')}}">Novo Curso</a>
</div>
<!-- Modal -->
