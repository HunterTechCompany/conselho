...
@section('main-page')
    <div class="p-tipos-atendimentos">
        <div>
            <div>
                <h1 class="titulo-pagina">Disciplinas</h1>
            </div>
        </div>
        <div>
        ...
        <div class="tabela-tipos-atendimentos font-size-756">
            <div class="grid-tabela-disciplinas border-bottom-conselho">
                <div>
                    <p class="m-0 font-weight-bold">Nome das disciplinas</p>
                </div>
                <div class="text-center">
                    <p class="m-0 font-weight-bold">Categoria da disciplina</p>
                </div>
                <div class="text-center">
            ...
            <div class="grid-tabela-disciplinas border-bottom-conselho">
                <div>
                    <p class="item-tipo-atendimento font-size-542">Redes de computadores</p>
                </div>
                <div>
                    <p class="item-tipo-atendimento text-center font-size-542">Técnica</p>
                </div>
                <div class="text-center">
